...
import { example_game } from "./example_game";
import { gexample } from "./example_commons";
import { Joystick, JOYSTICK_COLORS, JoystickPlacement } from "../../client/Joystick";
import { DataWriter } from "../../net/DataWriter";


const Snapshot = gexample.Snapshot;
type Snapshot = InstanceType<typeof gexample.Snapshot>;
...
export const example_client: ClientInterface<Snapshot, Memory> = {
	game: example_game,
	name: "Pingouins",
